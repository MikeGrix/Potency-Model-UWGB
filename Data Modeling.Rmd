...
columns_to_use <- c("Family","Production.Set.Point.A","Production.Set.Point.B","Production.Set.Point.C","Production.Set.Point.D","Growth.Time.A","Growth.Slope.A","Growth.Slope.B","Growth.Max","Growth.Slope.C","Growth.Time.B",
...
test_data <- test_data[, c(columns_to_use, "corrected_potency")]
...
test_rmse <- sqrt(mean((test_data$corrected_potency - rfr_predictions_original_scale)^2))
...
data_temp <- test_data %>% select(-corrected_potency)

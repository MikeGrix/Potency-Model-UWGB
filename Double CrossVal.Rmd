...
summary(new_data$Relative_Potency)

# Visualize (example with two variables)
library(ggplot2)
ggplot(new_data, aes(x = Growth.Time.B, y = Adjuvent.Conc, fill = Relative_Potency)) +
  geom_tile() +
  labs(title = "Predicted Outcomes Across Variable Ranges",
       x = "Growth Time B",
       y = "Adjuvent Concentration") +
